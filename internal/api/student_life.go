...
/* Six more of the child's own screens, and the awkward half of the product.
   ...
   Three of the five are children writing where other children read: the wall,
   a lost-property claim naming what is inside somebody's bag, and a hand-raise record that says which children are never called on.
...
// mountStudentLife registers the wall, diary, display-preference, hand-raise
// and lost-property-claim routes. (The homework forum was removed 2026-09-23.)
