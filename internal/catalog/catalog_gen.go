...
// Roles is the catalog: 10 roles, 411 features.
var Roles = []Role{
	{
		Key:  "seller_admin",
		...
		Sections: []Section{
			{
				...
				Features: []Feature{
					...
					{Key: "seller_admin.customers.provision_new_school", Slug: "provision_new_school", Name: "Provision New School", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Create a tenant, its first branch and its first administrator in one step, and send the welcome credentials."},
			...
			},
			{
				...
				Features: []Feature{
					{Key: "seller_admin.usage_health.adoption_stats", Slug: "adoption_stats", Name: "Adoption Stats", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Sign-ins, active users and transactions per school per week — the leading indicator of renewal."},
		...
		Sections: []Section{
			{
				...
				Workspace: "Dashboard",
				Features: []Feature{
					{Key: "super_admin.dashboard.branch_cards", Slug: "branch_cards", Name: "Branch cards", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Show one card per branch instead of generic summary boxes. Each branch card shows Branch Name, Total Students, Fee Collected, Outstanding Fee, with a View Branch action."},
					{Key: "super_admin.dashboard.all_branches_summary", Slug: "all_branches_summary", Name: "All branches summary", Scope: Scope("platform"), Tier: Tier("core"), Summary: "A small overall strip above/below branch cards: total branches, total students, total fee collected, total outstanding. Keep this secondary to branch cards."},
					{Key: "super_admin.dashboard.alerts", Slug: "alerts", Name: "Alerts", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Only system-level issues needing action: failed integrations, payment reconciliation failures, inactive branch setup, security alerts."},
					{Key: "super_admin.dashboard.multi_branch_revenue_summary", Slug: "multi_branch_revenue_summary", Name: "Multi-Branch Revenue Summary", Scope: Scope("platform"), Tier: Tier("core"), Summary: "View aggregate fee collection, outstanding balances, and comparative revenue across branches."},
					{Key: "super_admin.dashboard.admission_status_overview", Slug: "admission_status_overview", Name: "Admission Status Overview", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Track total inquiries, applications, admissions finalized, and conversion rate across all branches."},
					{Key: "super_admin.dashboard.global_attendance_heatmap", Slug: "global_attendance_heatmap", Name: "Global Attendance Heatmap", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Monitor real-time student and staff attendance percentages across all branch locations."},
					{Key: "super_admin.dashboard.critical_system_alerts", Slug: "critical_system_alerts", Name: "Critical System Alerts", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Display system-critical alerts including integration downtime, security breaches, and pending audits."},
			...
			},
			{
				...
				Features: []Feature{
					{Key: "super_admin.school_setup.schools_branches", Slug: "schools_branches", Name: "Schools & branches", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Create/edit school and branches; address, timezone, academic model, contact details and status."},
					{Key: "super_admin.school_setup.academic_year_defaults", Slug: "academic_year_defaults", Name: "Academic year defaults", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Set active academic year/term defaults per branch; actual academic structure remains with school admins."},
					{Key: "super_admin.school_setup.branding", Slug: "branding", Name: "Branding", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Logo, school name, colors and portal identity per tenant/branch."},
					{Key: "super_admin.school_setup.school_settings", Slug: "school_settings", Name: "School settings", Scope: Scope("institution"), Tier: Tier("core"), Summary: "School profile, branches, academic year and numbering."},
				},
			},
			{
				...
				Features: []Feature{
					...
					{Key: "super_admin.access_security.roles_permissions", Slug: "roles_permissions", Name: "Roles & permissions", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Assign roles and define data scope such as school, branch, department, class or self."},
			...
			},
			{
				...
				Features: []Feature{
					{Key: "super_admin.platform_configuration.module_configuration", Slug: "module_configuration", Name: "Module configuration", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Enable/disable modules by school so users only see what their school uses."},
			...
			},
			{
				...
				Features: []Feature{
					{Key: "super_admin.branches_academic_year.franchise_management", Slug: "franchise_management", Name: "Franchise Management", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Centralized administrative oversight, asset sharing, and brand compliance for franchise chains."},
					{Key: "super_admin.branches_academic_year.white_label_branding", Slug: "white_label_branding", Name: "White-Label Branding", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Configure custom logos, domain names, color themes, login portal banners, and email header templates."},
					{Key: "super_admin.branches_academic_year.academic_calendar_model", Slug: "academic_calendar_model", Name: "Academic Calendar Model", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Configure the June-April school year separately from the April-March financial year used for receipts."},
				},
			},
			{
				Slug:      "messaging",
			...
			},
			{
				...
				Workspace: "Platform Setup",
				Features: []Feature{
					{Key: "super_admin.transport_maintenance.data_backup_restore", Slug: "data_backup_restore", Name: "Data Backup & Restore", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Schedule automated cloud database backups and manage point-in-time recovery archives."},
					{Key: "super_admin.transport_maintenance.system_health_integration_alerts", Slug: "system_health_integration_alerts", Name: "System Health & Integration Alerts", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Monitor failed Webhooks, payment gateway time-outs, SMS delivery failures, and API errors."},
				},
			},
			{
				Slug:      "ai_automation",
				...
				Features: []Feature{
					{Key: "super_admin.ai_automation.automated_timetable_optimizer", Slug: "automated_timetable_optimizer", Name: "Automated Timetable Optimizer", Scope: Scope("platform"), Tier: Tier("core"), Summary: "Genetic algorithms solving complex multi-variable teacher, room, and elective timetable constraints."},
		...
		Sections: []Section{
			{
				...
				Workspace: "Home",
				Features: []Feature{
					{Key: "institution_admin.home.school_overview", Slug: "school_overview", Name: "School Overview", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Students, teacher/staff, attendance today, fee collection, outstanding fees and admissions. Show only 5-7 cards."},
					{Key: "institution_admin.home.needs_attention", Slug: "needs_attention", Name: "Needs attention", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Pending approvals, attendance shortage, absent teacher, timetable conflicts, marks not submitted and overdue fees."},
					...
					{Key: "institution_admin.home.department_overview", Slug: "department_overview", Name: "Department Overview", Scope: Scope("department"), Tier: Tier("core"), Summary: "Department students, teacher, today's classes, student attendance, teacher attendance and pending approvals."},
					{Key: "institution_admin.home.academic_overview", Slug: "academic_overview", Name: "Academic Overview", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Attendance, syllabus coverage and exam readiness across the school, with what needs attention today."},
				},
			},
			{
				Slug:      "approvals",
				...
				Features: []Feature{
					...
					{Key: "institution_admin.approvals.approvals", Slug: "approvals", Name: "Approvals", Scope: Scope("department"), Tier: Tier("core"), Summary: "Teacher leave, attendance corrections, marks submissions, add/drop and department requests."},
				},
			},
			{
				Slug:      "students",
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "institution_admin.academics.timetable", Slug: "timetable", Name: "Timetable", Scope: Scope("institution"), Tier: Tier("core"), Summary: "View/manage class, teacher and room timetable; resolve conflicts and substitutions."},
					{Key: "institution_admin.academics.master_timetable_generation", Slug: "master_timetable_generation", Name: "Master Timetable Generation", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Auto-generate clash-free class/teacher timetables with room and subject constraints."},
					{Key: "institution_admin.academics.teacher_substitution_engine", Slug: "teacher_substitution_engine", Name: "Teacher Substitution Engine", Scope: Scope("institution"), Tier: Tier("core"), Summary: "View absent teachers and assign available proxy teachers based on free periods and expertise."},
					...
					{Key: "institution_admin.academics.lesson_plan_approval_queue", Slug: "lesson_plan_approval_queue", Name: "Lesson Plan Approval Queue", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Review, comment, approve, or reject daily/weekly lesson plans submitted by teacher."},
					...
					{Key: "institution_admin.academics.attendance_monitoring", Slug: "attendance_monitoring", Name: "Attendance monitoring", Scope: Scope("institution"), Tier: Tier("core"), Summary: "School/class/department attendance, absent list, shortage list and trends."},
			...
			},
			{
				...
				Workspace: "Staff",
				Features: []Feature{
					{Key: "institution_admin.directory_workload.staff_allocation_workload", Slug: "staff_allocation_workload", Name: "Staff Allocation & Workload", Scope: Scope("institution"), Tier: Tier("core"), Summary: "View teacher period allocations, weekly teaching load, and balance teacher workloads."},
					{Key: "institution_admin.directory_workload.teacher_directory", Slug: "teacher_directory", Name: "Teacher directory", Scope: Scope("department"), Tier: Tier("core"), Summary: "Department teacher with assigned subjects, timetable, attendance and workload."},
					{Key: "institution_admin.directory_workload.teacher_allocation_workload", Slug: "teacher_allocation_workload", Name: "Teacher allocation & workload", Scope: Scope("department"), Tier: Tier("core"), Summary: "Allocate subjects/classes and balance teaching load; identify overload and gaps."},
					{Key: "institution_admin.directory_workload.teacher_directory_workload", Slug: "teacher_directory_workload", Name: "Teacher directory & workload", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Teaching staff, their allocations and how loaded each one is."},
				},
			},
			{
				Slug:      "evaluation",
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "institution_admin.department.department_timetable", Slug: "department_timetable", Name: "Department timetable", Scope: Scope("department"), Tier: Tier("core"), Summary: "View class/teacher/room timetable and manage department substitutions within permission."},
				},
			},
			{
				Slug:      "communication",
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "institution_admin.standard.exam_grade_summary", Slug: "exam_grade_summary", Name: "Exam & Grade Summary", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Analyze grade distribution charts, subject pass percentages, toppers, and low performers."},
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "institution_admin.analysis.performance_summary", Slug: "performance_summary", Name: "Performance summary", Scope: Scope("department"), Tier: Tier("core"), Summary: "Subject pass rate, semester trends, at-risk students and department performance."},
			...
			},
			{
				...
				Features: []Feature{
					{Key: "institution_admin.transport.automated_rta_compliance_alerts", Slug: "automated_rta_compliance_alerts", Name: "Automated RTA Compliance Alerts", Scope: Scope("campus"), Tier: Tier("core"), Summary: "A statutory compliance ledger that tracks FC, Insurance, PUC, and Form-5 Heavy License expiration dates, alerting transport managers 30 days prior."},
					...
					{Key: "institution_admin.transport.bus_speeding_rash_driving_alerts", Slug: "bus_speeding_rash_driving_alerts", Name: "Bus Speeding & Rash Driving Alerts", Scope: Scope("campus"), Tier: Tier("advanced"), Summary: "Receive immediate dashboard alerts if a driver exceeds pre-set branch speed limits."},
		...
		Sections: []Section{
			{
				...
				Features: []Feature{
					...
					{Key: "hod.timetable.department_timetable", Slug: "department_timetable", Name: "Department timetable", Scope: Scope("department"), Tier: Tier("core"), Summary: "The department's grid by class, by teacher and by room, read together so a gap in one is explained by the other two."},
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "hod.academics.teacher_allocation", Slug: "teacher_allocation", Name: "Teacher allocation", Scope: Scope("department"), Tier: Tier("core"), Summary: "Which teacher teaches which subject to which section, across the department, with each teacher's total periods shown so the load can be seen while it is being set."},
				},
			},
			{
				Slug:      "staff",
		...
		Sections: []Section{
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "faculty.my_classes.student_progress", Slug: "student_progress", Name: "Student progress", Scope: Scope("assigned_classes"), Tier: Tier("core"), Summary: "View attendance and academic progress for students taught/mentored by the teacher member."},
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "faculty.timetable.substitution_request_submission", Slug: "substitution_request_submission", Name: "Substitution Request Submission", Scope: Scope("assigned_classes"), Tier: Tier("core"), Summary: "Request advance leave and propose peer teacher substitution for approval."},
				},
			},
			{
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "faculty.assessment_schemes.tsbse_cce_board_calculation_adjustments", Slug: "tsbse_cce_board_calculation_adjustments", Name: "TSBSE CCE Board Calculation Adjustments", Scope: Scope("assigned_classes"), Tier: Tier("advanced"), Summary: "A built-in exam engine pre-configured for TSBSE raw mark rules, grade point mappings, and pass threshold validations (28/80 written exam cutoff)."},
				},
			},
			{
		...
		Sections: []Section{
			{
				...
				Workspace: "Home",
				Features: []Feature{
					{Key: "finance.home.fee_finance_overview", Slug: "fee_finance_overview", Name: "Fee & Finance Overview", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Today's collection, month collection, outstanding, overdue, refunds pending and failed/unreconciled online payments."},
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "finance.collections.cashless_branch_wallet", Slug: "cashless_branch_wallet", Name: "Cashless Branch Wallet", Scope: Scope("campus"), Tier: Tier("core"), Summary: "Manage student smart card balances for cashless purchases in school canteen and store."},
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "finance.reports.hard_daily_cashbook_lockout", Slug: "hard_daily_cashbook_lockout", Name: "Hard Daily Cashbook Lockout", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Automated system lock at 5:00 PM. No prior receipt can be edited, deleted, or backdated without administrative authorization and audit trail logging."},
		...
		Sections: []Section{
			{
				...
				Workspace: "Home",
				Features: []Feature{
					{Key: "admissions.home.admissions_overview", Slug: "admissions_overview", Name: "Admissions Overview", Scope: Scope("institution"), Tier: Tier("core"), Summary: "New enquiries, applications received, incomplete applications, interviews/tests today, offers pending and enrollments."},
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "admissions.visitors.visitor_checkout_tracking", Slug: "visitor_checkout_tracking", Name: "Visitor Checkout Tracking", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Scan visitor barcode or log exit time to ensure no unauthorized visitors remain on branch."},
			...
			},
			{
				...
				Workspace: "Reports",
				Features: []Feature{
					{Key: "admissions.reports.admission_conversion_reports", Slug: "admission_conversion_reports", Name: "Admission Conversion Reports", Scope: Scope("institution"), Tier: Tier("core"), Summary: "View funnel summary: Inquiries -> Form Bought -> Exam Taken -> Offer Issued -> Enrolled."},
		...
		Sections: []Section{
			{
				...
				Workspace: "Home",
				Features: []Feature{
					{Key: "hr.home.staff_overview", Slug: "staff_overview", Name: "Staff Overview", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Headcount, present/absent today, leave pending, new joiners and payroll status if payroll enabled."},
				},
			},
			{
				Slug:      "records",
				...
				Workspace: "Employees",
				Features: []Feature{
					{Key: "hr.records.employee_master", Slug: "employee_master", Name: "Employee master", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Employee/teacher profiles, department, designation, documents and employment status."},
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "hr.hiring_growth.annual_staff_appraisal", Slug: "annual_staff_appraisal", Name: "Annual Staff Appraisal", Scope: Scope("institution"), Tier: Tier("core"), Summary: "Set staff goals, collect peer/principal ratings, and process annual increment percentages."},
	...
	},
	{
		...
		Sections: []Section{
			...
			},
			{
				...
				Workspace: "Academics",
				Features: []Feature{
					{Key: "student.attendance.attendance", Slug: "attendance", Name: "Attendance", Scope: Scope("self"), Tier: Tier("core"), Summary: "Overall, subject-wise and date-wise attendance; leave/correction request if school allows."},
				},
			},
			{
				Slug:      "homework",
			...
			},
			{
				...
				Workspace: "School",
				Features: []Feature{
					{Key: "student.branch_life.student_wall_peer_recognition", Slug: "student_wall_peer_recognition", Name: "Student Wall & Peer Recognition", Scope: Scope("self"), Tier: Tier("optional"), Summary: "View school news, student council announcements, badge achievements, and art features."},
					{Key: "student.branch_life.digital_hall_of_fame", Slug: "digital_hall_of_fame", Name: "Digital Hall of Fame", Scope: Scope("self"), Tier: Tier("optional"), Summary: "Showcase historic trophies, school record holders, and national rankers across academic/sports."},
					{Key: "student.branch_life.student_club_event_ticketing_qr_check_in", Slug: "student_club_event_ticketing_qr_check_in", Name: "Student Club Event Ticketing & QR Check-In", Scope: Scope("self"), Tier: Tier("optional"), Summary: "Register for branch drama, music, or science events and generate QR-coded admission tickets."},
					{Key: "student.branch_life.lost_found_item_board", Slug: "lost_found_item_board", Name: "Lost & Found Item Board", Scope: Scope("self"), Tier: Tier("optional"), Summary: "Post missing items or report found items with photos on the digital lost-and-found board."},
					{Key: "student.branch_life.lost_found_photo_board_with_claim_verification", Slug: "lost_found_photo_board_with_claim_verification", Name: "Lost & Found Photo Board with Claim Verification", Scope: Scope("self"), Tier: Tier("optional"), Summary: "View photos of lost items found on branch and submit digital claim proof to reclaim items."},
					{Key: "student.branch_life.digital_locker_combination_access_log", Slug: "digital_locker_combination_access_log", Name: "Digital Locker Combination & Access Log", Scope: Scope("self"), Tier: Tier("optional"), Summary: "Manage assigned physical hallway locker numbers and view digital access keycode history."},
				},
			},
			{
				Slug:      "alumni",
			...
			},
			{
				...
				Workspace: "Requests",
				Features: []Feature{
					{Key: "student.requests.requests", Slug: "requests", Name: "Requests", Scope: Scope("self"), Tier: Tier("core"), Summary: "Leave, certificate, bonafide, ID card, add/drop or help request depending on school type."},
				},
			},
			{
				Slug:      "profile",
		...
		Sections: []Section{
			...
			},
			{
				...
				Features: []Feature{
					...
					{Key: "parent.profile.digital_parent_id_card_for_branch_entry", Slug: "digital_parent_id_card_for_branch_entry", Name: "Digital Parent ID Card for Branch Entry", Scope: Scope("children"), Tier: Tier("optional"), Summary: "Display dynamic encrypted QR code parent ID on mobile app screen for entry at school gates."},
