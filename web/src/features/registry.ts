...
export const FEATURE_COMPONENTS: Record<string, LazyExoticComponent<ComponentType>> = {
  ...
  'admissions.admissions.all_admissions': lazy(() => import('./admissions/Pipeline')),
  'admissions.admissions.merit_lists_seat_allotment': lazy(() => import('./admissions/Pipeline')),
  'admissions.admissions.rte_admissions': lazy(() => import('./admissions/Pipeline')),
  'admissions.admissions.fee_payment_enrolment': lazy(() => import('./admissions/Pipeline')),
  'admissions.admissions.waitlist': lazy(() => import('./admissions/Funnel')),
  'admissions.admissions.government_ids': lazy(() => import('./admissions/Funnel')),
  'admissions.front_desk.visitors_log': lazy(() => import('./admissions/FrontDesk')),
  'admissions.front_desk.parent_appointments': lazy(() => import('./admissions/FrontDesk')),
  'admissions.front_desk.daily_call_log': lazy(() => import('./admissions/FrontDesk')),
  'admissions.front_desk.dispatch_courier': lazy(() => import('./admissions/FrontDesk')),
  ...
  'admissions.reports.admission_reports': lazy(() => import('./admissions/Pipeline')),
