    ...
    sections: [
      ...
      },
      {
        ...
        features: [
          ...
          { key: 'super_admin.statutory_boards.digilocker_issuer_integration', slug: 'digilocker_issuer_integration', name: 'DigiLocker Issuer Integration', scope: 'platform', tier: 'advanced', summary: 'Not buildable here: needs NeGD issuer onboarding and DigiLocker\'s pull API credentials, which this deployment does not hold. Push transfer certificates, report cards and mark sheets as verifiable documents.' },
    ...
    sections: [
      ...
      },
      {
        ...
        features: [
          ...
          { key: 'institution_admin.students.student_photographs', slug: 'student_photographs', name: 'Student photographs', scope: 'institution', tier: 'core', summary: 'The photographer\'s folder attached to children in one go, matched by admission number. Photographs print on the ID card and on the report card.' },
    ...
    sections: [
      ...
      },
      {
        ...
        features: [
          ...
          { key: 'faculty.question_papers_online_tests.ai_examcell_paper_generator', slug: 'ai_examcell_paper_generator', name: 'AI Examcell Paper Generator', scope: 'assigned_classes', tier: 'advanced', summary: 'A paper drawn from the question bank by blueprint: so many of each difficulty, kind, chapter and mark value, at random. Nothing is written; a row the bank cannot fill says by how many.' },
          { key: 'faculty.question_papers_online_tests.ved_ai_assessment_assistant', slug: 'ved_ai_assessment_assistant', name: 'Ved AI Assessment Assistant', scope: 'assigned_classes', tier: 'advanced', summary: 'Not buildable here: needs a language model to suggest rubric criteria, quiz questions and essay prompts, and this deployment has none.' },
    ...
    sections: [
      ...
      },
      {
        ...
        features: [
          ...
          { key: 'hr.attendance.staff_working_hours', slug: 'staff_working_hours', name: 'Staff Working Hours', scope: 'institution', tier: 'core', summary: 'The hours this school expects, named by the school and assigned to a department or a person: teaching, office and transport rarely start together. Each set says what counts as a full day, when somebody is late, and how -- or whether -- the school cuts pay for a day lost.' },
