...
export const en = {
  ...
  // The calmer parent home: eight cells, short copy, the figure first.
  'bento.parent_week.attention_label': 'Needs you',
  'bento.parent_week.attention_none': 'Nothing waiting on you.',
  'bento.parent_week.attention_unread': 'Could not check just now.',
  'bento.parent_week.attention_cue': 'Open',
  'bento.parent_week.attention_sr': 'Everything else waiting on you',
  'bento.parent_week.fees_label_clear': 'Fees',
  'bento.parent_week.fees_settled_short': 'All paid up.',
  'bento.parent_week.fees_owed_short': 'Payable now.',
  'bento.parent_week.fees_overdue': 'Instalment {n} · {days} days overdue',
  'bento.parent_week.fees_due_on': 'Instalment {n} · due {date}',
  'bento.parent_week.fees_pay_cue': 'Pay now',
  'bento.parent_week.week_note_short': '{present} of {total} days · {absent} absent',
  'bento.parent_week.today_label': 'Today',
  'bento.parent_week.today_free': 'No classes',
  'bento.parent_week.today_free_note': 'Nothing on the timetable today.',
  'bento.parent_week.today_over': 'Day done',
  'bento.parent_week.today_over_note': '{count} periods, all finished.',
  'bento.parent_week.today_now': 'Now',
  'bento.parent_week.today_next': 'Next',
  'bento.parent_week.today_cue': 'The timetable',
  'bento.parent_week.today_sr': 'The rest of {name}’s day',
  'bento.parent_week.homework_none_short': 'Nothing due.',
  'bento.parent_week.due_today': 'due today',
  'bento.parent_week.due_tomorrow': 'due tomorrow',
  'bento.parent_week.due_on': 'due {date}',
  'bento.parent_week.bus_label': 'Bus',
  'bento.parent_week.bus_cue': 'Live bus tracking',
  'bento.parent_week.bus_min': '{min} min',
  'bento.parent_week.bus_moving': 'On its way to {stop}',
  'bento.parent_week.bus_arrived': 'Arrived at {at}',
  'bento.parent_week.bus_quiet': 'No position for a while.',
  'bento.parent_week.bus_scheduled': 'Due {at} at {stop}',
  'bento.parent_week.bus_sr': 'The bus {name} travels on',
  'bento.parent_week.fact_route': 'Route',
  'bento.parent_week.fact_vehicle': 'Vehicle',
  'bento.parent_week.fact_driver': 'Driver',
  'bento.parent_week.fact_away': 'Away',
  'bento.parent_week.messages_label': 'Messages',
  'bento.parent_week.messages_cue': 'Write to a teacher',
  'bento.parent_week.messages_none': 'No new messages.',
  'bento.parent_week.messages_from': 'New from {name}',
  'bento.parent_week.messages_unread_failed': 'Could not check just now.',
  'bento.parent_week.messages_sr': 'Who has written',
  'bento.parent_week.unread_n': '{n} new',
  'bento.parent_week.results_label': 'Last result',
  'bento.parent_week.next_exam_label': 'Next exam',
  'bento.parent_week.results_none': 'No result published yet.',
  'bento.parent_week.results_cue': 'Results and report cards',
  'bento.parent_week.results_sr': '{name}’s latest result',
  'bento.parent_week.fact_grade': 'Grade',
  'bento.parent_week.head_recent': 'Last 30 school days',
  'bento.parent_week.head_recent_wide': 'Last 60 school days',
  'bento.parent_week.fact_which': 'Exam',
  'bento.parent_week.next_exam_note': 'Next: {exam}',
  'bento.parent_week.grade': 'grade {grade}',
  ...
  'bento.widgets.layouts': 'Layout',
  'bento.widgets.preset.default': 'As designed',
  'bento.widgets.preset.default.hint': 'Every card at the size it was drawn for',
  'bento.widgets.preset.compact': 'Compact',
  'bento.widgets.preset.compact.hint': 'Everything small; the whole board at a glance',
  'bento.widgets.preset.spotlight': 'Spotlight',
  'bento.widgets.preset.spotlight.hint': 'One large card, the rest small around it',
  'bento.widgets.preset.banner': 'Banner',
  'bento.widgets.preset.banner.hint': 'A band across the top, a row of figures under it',
  ...
  'bento.widgets.edit_home': 'Edit home',
  'bento.widgets.edit_board': 'Edit',
  // Customize mode: the bar, the on-card controls, the phone's reorder list.
  'bento.widgets.customize': 'Customize',
  'bento.widgets.announce': 'Customizing the board',
  'bento.widgets.remove_card': 'Remove {label}',
  'bento.widgets.colour_row': 'Colour…',
  'bento.widgets.add_card': 'Add',
  'bento.widgets.nothing_to_add': 'Every card is on the board',
  'bento.widgets.reorder': 'Reorder',
  'bento.widgets.sheet_title': 'Reorder cards',
  'bento.widgets.sheet_hint': 'Drag a row to move its card. The board follows behind this sheet.',
  'bento.widgets.drag': 'Drag {label}',
  'bento.widgets.shown': 'Shown',
  ...
  /* AddGallery.tsx — the "Add a card" gallery, on the desk's arrange bar and
     ...
     the picker. */
  'bento.add_gallery.title': 'Add a card',
  'bento.add_gallery.hint': 'Choose a card and a size. It goes straight onto the board.',
  'bento.add_gallery.close': 'Close',
  'bento.add_gallery.cards': 'Cards not on the board',
  'bento.add_gallery.empty': 'Everything is on the board',
  'bento.add_gallery.no_room': 'No room at this size',
  'bento.add_gallery.added': 'Added',
  'bento.add_gallery.add_as': 'Add {label}, {size}',
  'bento.add_gallery.keys': 'Arrow keys move between cards · Enter adds · 1–4 pick a size',
  'bento.parent_week.attention_count': '{count} things waiting on you.',
  ...
  'bento.colour.region.buttons': 'Buttons',
  ...
  'bento.settings.tab.dashboard': 'Dashboard',
  'bento.settings.tab.school': 'School',
  'bento.settings.tab.messaging': 'Messaging',
  'bento.settings.tab.account': 'Account',
  ...
  'bento.widgets.period': 'Period',
  'bento.period.today': 'Today',
  'bento.period.yesterday': 'Yesterday',
  'bento.period.week': 'This week',
  'bento.period.month': 'This month',
  'bento.period.term': 'This term',
