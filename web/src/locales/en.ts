...
export const en = {
  ...
  'bento.settings.text': 'App text size',
  'bento.settings.board_text': 'Dashboard text size',
  ...
  'bento.faculty_today.head_due': 'Due: late · today · week · later',
  'bento.faculty_today.head_roll': 'Roll by section',
  'bento.faculty_today.head_taken': 'Registers taken today',
  'bento.faculty_today.head_waiting': 'Pupils waiting on a register',
  'bento.faculty_today.head_subject': 'Minutes by subject',
  'bento.faculty_today.head_class': 'Minutes by class',
  'bento.faculty_today.track_in': 'In',
  'bento.faculty_today.track_out': 'To take',
  'bento.faculty_today.track_taken': 'Taken',
  'bento.faculty_today.track_owed': 'Owed',
  'bento.faculty_today.fact_first': 'First bell',
  'bento.faculty_today.fact_last': 'Last bell',
  'bento.faculty_today.fact_teaching': 'Teaching',
  'bento.faculty_today.fact_between': 'Between lessons',
  'bento.faculty_today.fact_registers': 'Registers in',
  'bento.faculty_today.fact_next': 'Next starts',
  'bento.faculty_today.fact_period': 'Period now',
  'bento.faculty_today.fact_lessons': 'Lessons',
  'bento.faculty_today.fact_in': 'Marked',
  'bento.faculty_today.fact_out': 'Still to mark',
  'bento.faculty_today.fact_waiting': 'Pupils waiting',
  'bento.faculty_today.fact_kinds': 'Kinds',
  'bento.faculty_today.fact_rows': 'Items',
  'bento.faculty_today.fact_late': 'Overdue items',
  'bento.faculty_today.fact_sections': 'Sections',
  'bento.faculty_today.fact_pupils': 'Pupils',
  'bento.faculty_today.fact_largest': 'Largest',
  'bento.faculty_today.fact_smallest': 'Smallest',
  'bento.faculty_today.kind_submissions': 'Marking',
  'bento.faculty_today.kind_marks': 'Marks',
  'bento.faculty_today.kind_substitution': 'Cover',
  'bento.faculty_today.kind_leave': 'Leave',
  'bento.faculty_today.kind_announcement': 'Notices',
  'bento.faculty_today.rail_sr': 'Now, between the first bell at {first} and the last at {last}',
  'bento.faculty_today.bars_sr': 'The lengths of your {count} timetabled lessons, {total} of teaching in all',
  'bento.faculty_today.kinds_sr': 'What is outstanding on you, by kind',
  'bento.faculty_today.due_sr': 'Dated work by when it falls due: late, today, this week, later',
  'bento.faculty_today.roll_sr': 'The roll of each of your {count} sections, {pupils} pupils in all',
  'bento.faculty_today.taken_sr': 'Registers taken in {taken} of your {count} sections today',
  'bento.faculty_today.waiting_sr': '{pupils} pupils in lessons whose register is not in yet',
  'bento.faculty_today.subject_sr': 'Minutes you teach each subject today, {total} in all',
  'bento.faculty_today.class_sr': 'Minutes you teach each class today, {total} in all',
  'bento.faculty_today.facts_sr': 'The figures behind this one',
  'bento.faculty_today.no_bells': 'No bell times are set on today’s timetable.',
  'bento.faculty_today.no_dates': 'None of it carries a date.',
  'bento.faculty_today.sections_none': 'No sections are assigned to you.',
  'bento.student_day.head_day': 'The day, period by period',
  'bento.student_day.head_now': 'Where you are in the day',
  'bento.student_day.head_statuses': 'Every status in the register',
  'bento.student_day.head_trend': 'Weeks in school',
  'bento.student_day.head_weekday': 'Days missed, by weekday',
  'bento.student_day.head_unpaid': 'What is left on each bill',
  'bento.student_day.track_present': 'Present',
  'bento.student_day.track_absent': 'Absent',
  'bento.student_day.track_other': 'Late, leave, half day',
  'bento.student_day.track_paid': 'Paid',
  'bento.student_day.track_due': 'Still due',
  'bento.student_day.fact_first': 'First bell',
  'bento.student_day.fact_last': 'Last bell',
  'bento.student_day.fact_lessons': 'Lessons',
  'bento.student_day.fact_taught': 'Timetabled',
  'bento.student_day.fact_teacher': 'Teacher',
  'bento.student_day.fact_marked': 'Days marked',
  'bento.student_day.fact_present': 'Present',
  'bento.student_day.fact_absent': 'Absent',
  'bento.student_day.fact_other': 'Late or leave',
  'bento.student_day.fact_run': 'Current run',
  'bento.student_day.fact_longest': 'Longest run',
  'bento.student_day.fact_weeks': 'Weeks marked',
  'bento.student_day.fact_due': 'Pieces owed',
  'bento.student_day.fact_soonest': 'Soonest due',
  'bento.student_day.fact_piece': 'Which piece',
  'bento.student_day.fact_in_days': 'That is',
  'bento.student_day.fact_exam': 'Next exam',
  'bento.student_day.fact_billed': 'Billed',
  'bento.student_day.fact_paid': 'Paid',
  'bento.student_day.fact_owed': 'Owed',
  'bento.student_day.fact_invoices': 'Bills unpaid',
  'bento.student_day.fact_overdue': 'Past the due date',
  'bento.student_day.days_late': '{days} days late',
  'bento.student_day.days_out': 'in {days} days',
  'bento.student_day.rail_sr': 'Now, between the first bell at {first} and the last at {last}',
  'bento.student_day.bars_sr': 'The lengths of your {count} periods today, {total} in all',
  'bento.student_day.statuses_sr': 'Your marked days, by status',
  'bento.student_day.trend_sr': 'The share of each week’s marked days you were in school, over {weeks} weeks',
  'bento.student_day.weekday_sr': 'Which weekdays your {count} missed days fall on',
  'bento.student_day.homework_sr': 'What is known about the {count} pieces still owed',
  'bento.student_day.fees_sr': '{paid} paid of {billed} billed',
  'bento.student_day.unpaid_sr': 'What is left on each of your {count} unpaid bills',
  'bento.student_day.facts_sr': 'The figures behind this one',
  'bento.student_day.no_bells': 'No bell times are set on today’s timetable.',
  'bento.student_day.no_register': 'No day has been marked for you yet.',
  'bento.student_day.register_unread': 'Your register could not be read just now.',
  'bento.student_day.too_short': 'Not enough marked weeks yet to draw a trend.',
  'bento.student_day.no_invoices': 'No bill has been raised for you yet.',
  'bento.student_day.ledger_unread': 'Your bills could not be read just now.',
  'bento.parent_week.head_trend': 'Weeks in school',
  'bento.parent_week.head_statuses': 'Every status in the register',
  'bento.parent_week.head_weekday': 'Days missed, by weekday',
  'bento.parent_week.head_kinds': 'What the missed days were',
  'bento.parent_week.head_months': 'Days present, by month',
  'bento.parent_week.head_unpaid': 'What is left on each bill',
  'bento.parent_week.track_in': 'In school',
  'bento.parent_week.track_out': 'Not in school',
  'bento.parent_week.track_paid': 'Paid',
  'bento.parent_week.track_due': 'Still due',
  'bento.parent_week.fact_marked': 'Days marked',
  'bento.parent_week.fact_present': 'Present',
  'bento.parent_week.fact_absent': 'Absent',
  'bento.parent_week.fact_missed': 'Days missed',
  'bento.parent_week.fact_worst_day': 'Most missed',
  'bento.parent_week.fact_run': 'Current run',
  'bento.parent_week.fact_longest': 'Longest run',
  'bento.parent_week.fact_weeks': 'Weeks marked',
  'bento.parent_week.fact_due': 'Pieces owed',
  'bento.parent_week.fact_soonest': 'Soonest due',
  'bento.parent_week.fact_piece': 'Which piece',
  'bento.parent_week.fact_in_days': 'That is',
  'bento.parent_week.fact_exam': 'Next exam',
  'bento.parent_week.fact_billed': 'Billed',
  'bento.parent_week.fact_paid': 'Paid',
  'bento.parent_week.fact_owed': 'Owed',
  'bento.parent_week.fact_invoices': 'Bills unpaid',
  'bento.parent_week.fact_overdue': 'Past the due date',
  'bento.parent_week.days_late': '{days} days late',
  'bento.parent_week.days_out': 'in {days} days',
  'bento.parent_week.trend_sr': 'The share of each week’s marked days {name} was in school, over {weeks} weeks',
  'bento.parent_week.statuses_sr': '{name}’s marked days, by status',
  'bento.parent_week.weekday_sr': 'Which weekdays {name}’s {count} missed days fall on',
  'bento.parent_week.kinds_sr': 'What {name}’s missed days were marked as',
  'bento.parent_week.months_sr': 'Days {name} was in school, month by month',
  'bento.parent_week.homework_sr': 'What is known about the {count} pieces {name} still owes',
  'bento.parent_week.fees_sr': '{paid} paid of {billed} billed on {name}’s account',
  'bento.parent_week.unpaid_sr': 'What is left on each of the {count} unpaid bills',
  'bento.parent_week.facts_sr': 'The figures behind this one, for {name}',
  'bento.parent_week.register_unread': '{name}’s register could not be read just now.',
  'bento.parent_week.too_short': 'Not enough marked weeks yet to draw a trend.',
  ...
  'bento.principal.card_money_empty': 'No fee has been invoiced or collected yet',
  'bento.principal.card_roll_empty': 'No student is on the roll yet',
  'bento.principal.syllabus_facts_sr': '{rows} class subjects, {behind} behind, {delivered} of {units} units delivered',
  'bento.principal.fact_class_subjects': 'Class subjects',
  'bento.principal.fact_behind': 'Behind',
  'bento.principal.fact_units_done': 'Units done',
  'bento.principal.moderation_facts_sr': '{total} papers, {unmoderated} still to moderate, {reviewed} reviewed',
  'bento.principal.fact_papers': 'Papers',
  'bento.principal.fact_to_moderate': 'To moderate',
  'bento.principal.fact_reviewed': 'Reviewed',
  'bento.principal.pass_rate_facts_sr': '{passed} of {total} candidates passed',
  'bento.principal.fact_candidates': 'Candidates',
  'bento.principal.fact_passed': 'Passed',
  'bento.principal.fact_at_risk': 'At risk',
  'bento.principal.at_risk_facts_sr': '{count} of {total} candidates carrying a backlog',
  'bento.principal.setup_facts_sr': '{done} of {total} steps done, {blocking} still blocking',
  'bento.principal.fact_steps_done': 'Steps done',
  'bento.principal.fact_blocking': 'Blocking',
  'bento.principal.fact_left': 'Still to do',
  'bento.principal.shortage_empty': 'No child is below the line',
  'bento.principal.unallocated_empty': 'No staff workload has been recorded yet',
  'bento.principal.tt_empty': 'No timetable has been built yet',
  'bento.principal.plans_empty': 'No lesson plan is waiting to be reviewed',
  'bento.principal.papers_empty': 'No question paper has been submitted yet',
  'bento.principal.calendar_rows_sr': 'The next entries of {count}, by how many days away each falls',
  'bento.principal.exams_empty': 'No exam has been scheduled yet',
  'bento.principal.messages_empty': 'Nothing unread',
  'bento.principal.classes_empty': 'No class has been set up yet',
  'bento.finance.owed_none': 'Nothing is owed',
  'bento.finance.receipts_none': 'No receipt has been banked in {label}',
  'bento.principal.card_unassigned_of': '{count} of {total} class-subjects have no teacher',
  'bento.principal.card_unassigned_of_sr': '{count} of {total} class-subjects have nobody timetabled to teach them; {covered} are covered',
  'bento.principal.fact_unassigned': 'No teacher',
  'bento.principal.fact_covered': 'Covered',
  'bento.principal.app_stage_draft': 'Draft',
  'bento.principal.app_stage_submitted': 'Submitted',
  'bento.principal.app_stage_under_review': 'Under review',
  'bento.principal.app_stage_documents_pending': 'Documents pending',
  'bento.principal.app_stage_test_scheduled': 'Test scheduled',
  'bento.principal.app_stage_interviewed': 'Interviewed',
  'bento.principal.app_stage_waitlisted': 'Waitlisted',
  'bento.principal.app_stage_offered': 'Offered',
  'bento.principal.card_applications_stage_line': '{stages} stages · most at {name} ({at})',
  'bento.principal.card_applications_stages_sr': '{count} open applications across {stages} stages: {detail}',
  'bento.principal.leave_kind_staff': 'staff',
  'bento.principal.leave_kind_student': 'students',
  'bento.principal.card_leave_row': '{type} · {kind}',
  'bento.principal.card_other_leave': 'Other types',
  'bento.principal.card_approvals_line': '{staff} staff · {students} student · {days} days',
  'bento.principal.card_approvals_split_sr': '{count} leave requests waiting: {staff} from staff, {students} from students, {days} working days in all. By type: {detail}',
  'bento.principal.card_roll_classes': '{classes} classes · {sections} sections · {staff} staff',
  'bento.principal.card_roll_classes_sr': '{count} students on roll across {classes} classes; the largest is {name} with {largest}',
  'bento.principal.card_class_repeat': '{name} ({n})',
  'bento.principal.card_other_classes': 'Other classes',
  'bento.principal.age_not_due': 'Not due',
  'bento.principal.age_0_30': '0-30 days',
  'bento.principal.age_31_60': '31-60 days',
  'bento.principal.age_61_90': '61-90 days',
  'bento.principal.age_90_plus': 'Over 90 days',
  'bento.principal.age_undated': 'No due date',
  'bento.principal.card_ageing_sr': '{total} outstanding, by how long it has been due: {detail}',
  'bento.principal.card_due_no_year': '{count} students owe · no year on any invoice',
  ...
  'bento.settings.personality': 'Personality',
  'bento.settings.personality.classic': 'Classic',
  'bento.settings.personality.ethereal': 'Ethereal',
  'bento.settings.personality.mono': 'Mono',
  'bento.settings.personality.ocean': 'Ocean',
  'bento.settings.personality.brutalist': 'Brutalist',
  'bento.settings.personality.playful': 'Playful',
  'bento.settings.personality.royal': 'Royal',
  'bento.settings.personality.terminal': 'Terminal',
  ...
  // --- the welfare boards: nurse, counsellor, discipline, warden, activities
  'bento.welfare.loading': 'Reading your day\u2026',
  'bento.welfare.failed': 'That did not load. Nothing here is zero because nothing was read.',

  'bento.welfare.nurse.eyebrow': 'The clinic',
  'bento.welfare.nurse.title': 'Today',
  'bento.welfare.nurse.visits': 'In the clinic today',
  'bento.welfare.nurse.visits_change': '{n} doses given',
  'bento.welfare.nurse.no_visits': 'Nobody has come in yet.',
  'bento.welfare.nurse.cue_visits': 'Open the visit register',
  'bento.welfare.nurse.doses': 'Doses given today',
  'bento.welfare.nurse.doses_note': 'Each with who allowed it.',
  'bento.welfare.nurse.no_doses': 'No medication given yet.',
  'bento.welfare.nurse.cue_doses': 'Open the medication register',
  'bento.welfare.nurse.flags': 'Children to know about',
  'bento.welfare.nurse.allergies': 'Allergies',
  'bento.welfare.nurse.chronic': 'Chronic conditions',
  'bento.welfare.nurse.no_flags': 'No allergy or condition is recorded.',
  'bento.welfare.nurse.cue_flags': 'Open the health records',

  'bento.welfare.counsellor.eyebrow': 'Counselling',
  'bento.welfare.counsellor.title': 'Today',
  'bento.welfare.counsellor.threads': 'Open conversations',
  'bento.welfare.counsellor.unread': '{n} unread',
  'bento.welfare.counsellor.urgent': 'Urgent',
  'bento.welfare.counsellor.unread_label': 'Unread',
  'bento.welfare.counsellor.no_threads': 'No family is waiting on you.',
  'bento.welfare.counsellor.cue_threads': 'Open family conversations',
  'bento.welfare.counsellor.concerns': 'Concerns this week',
  'bento.welfare.counsellor.of_notes': 'of {n} notes written',
  'bento.welfare.counsellor.no_concerns': 'No concern was written this week.',
  'bento.welfare.counsellor.cue_concerns': 'Open the conduct notes',
  'bento.welfare.counsellor.flags': 'Health flags',

  'bento.welfare.discipline.eyebrow': 'Discipline',
  'bento.welfare.discipline.title': 'Today',
  'bento.welfare.discipline.open': 'Incidents still open',
  'bento.welfare.discipline.of_term': 'of {n} this term',
  'bento.welfare.discipline.serious': 'Serious',
  'bento.welfare.discipline.suspensions': 'Suspensions',
  'bento.welfare.discipline.meetings': 'Parent meetings',
  'bento.welfare.discipline.nothing_open': 'Nothing is open.',
  'bento.welfare.discipline.cue_log': 'Open the incident log',
  'bento.welfare.discipline.week': 'Notes this week',
  'bento.welfare.discipline.praise': 'Praise',
  'bento.welfare.discipline.concerns': 'Concerns',
  'bento.welfare.discipline.no_notes': 'Nothing was written this week.',
  'bento.welfare.discipline.cue_notes': 'Open the conduct notes',
  'bento.welfare.discipline.serious_title': 'Serious incidents',
  'bento.welfare.discipline.serious_note': 'Each needs an action recorded.',
  'bento.welfare.discipline.no_serious': 'None this term.',

  'bento.welfare.warden.eyebrow': 'The hostel',
  'bento.welfare.warden.title': 'Today',
  'bento.welfare.warden.passes': 'Passes waiting on you',
  'bento.welfare.warden.out_now': '{n} out now',
  'bento.welfare.warden.out': 'Out',
  'bento.welfare.warden.late': 'Late back',
  'bento.welfare.warden.no_passes': 'No pass has been asked for.',
  'bento.welfare.warden.cue_passes': 'Open outpasses',
  'bento.welfare.warden.beds': 'Boarders in beds',
  'bento.welfare.warden.of_beds': 'of {n} beds',
  'bento.welfare.warden.free': 'Free',
  'bento.welfare.warden.rooms': 'Rooms',
  'bento.welfare.warden.no_rooms': 'No room has been set up.',
  'bento.welfare.warden.cue_beds': 'Open hostel and rooms',
  'bento.welfare.warden.complaints': 'Complaints open',
  'bento.welfare.warden.complaints_note': 'Raised from the hostel.',
  'bento.welfare.warden.no_complaints': 'Nothing is open.',
  'bento.welfare.warden.cue_complaints': 'Open complaints',

  'bento.welfare.activity.eyebrow': 'Activities',
  'bento.welfare.activity.title': 'Today',
  'bento.welfare.activity.running': 'Clubs and teams running',
  'bento.welfare.activity.enrolled': '{n} children enrolled',
  'bento.welfare.activity.places': 'Places left',
  'bento.welfare.activity.full': 'Full',
  'bento.welfare.activity.none': 'No activity is running.',
  'bento.welfare.activity.cue_running': 'Open clubs and activities',
  'bento.welfare.activity.publish': 'Waiting to publish',
  'bento.welfare.activity.consented': 'Consent given',
  'bento.welfare.activity.awaiting_consent': 'Awaiting consent',
  'bento.welfare.activity.nothing_to_publish': 'Nothing is waiting.',
  'bento.welfare.activity.cue_publish': 'Open the showcase',
