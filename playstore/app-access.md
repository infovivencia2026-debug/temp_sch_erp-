# App access — reviewer credentials for EDU CLOUD
...
Any other info:
  1. Open the app; it shows the EDU CLOUD sign-in.
...
1. Create (or reuse) a demo institution, e.g. "EDU CLOUD Demo School", with one class, one section, 3–5 fictitious students and fee structures.
